...
ARMOR_TOOLTIP = "Physical Damage Reduction"; -- Tooltip description for "Armor"
...
ATTACK_SPEED_COLON = "Attack Speed:"; -- Character's attack speed modifier, with colon
...
COMBATLOG_XPGAIN_EXHAUSTION3 = "%s dies, you gain %d experience.";
...
CONFIRM_XP_LOSS = "If you find your corpse, you can resurrect for no penalty.  Would you like me to resurrect you now for a loss of %d XP?";
CONFIRM_XP_LOSS_AGAIN = "Remember, if you find your corpse there is no penalty.  Are you sure you want to lose %d XP to resurrect now?";
...
ENABLE_TUTORIAL_TEXT = "Continue tutorials";
...
ERR_PET_SPELL_OUT_OF_RANGE = "Pet is out of range.";
...
ERR_RAID_GROUP_ONLY = "You are not in this instance's group";
...
FACTION_OTHER = "Other";
FACTION_STANDING_DECREASED1 = "Your reputation with %s has slightly decreased.";
FACTION_STANDING_DECREASED2 = "Your reputation with %s has decreased.";
FACTION_STANDING_DECREASED3 = "Your reputation with %s has greatly decreased.";
FACTION_STANDING_INCREASED1 = "Your reputation with %s has slightly increased.";
FACTION_STANDING_INCREASED3 = "Your reputation with %s has greatly increased.";
FACTION_STANDING_INCREASED2 = "Your reputation with %s has increased.";
...
HELPFRAME_HOME_TEXT = "Please select the option which best describes your Help request:"; -- Greeting text on the home tab of the HelpFrame
...
LOGOUT = "Logout";
LOG_PERIODIC_EFFECTS = "Display Periodic Effects";
LOOKING = "Looking";
...
OPTION_TOOLTIP_ASSIST_ATTACK = "Enable attack on assist";
OPTION_TOOLTIP_BLOCK_TRADES = "Block all incoming trade requests";
OPTION_TOOLTIP_BUFFERING = "Selects double or triple buffering of frames when vertical sync is enabled. Selecting triple buffering may improve your framerate.";
OPTION_TOOLTIP_CAMERA_MODE = "Changes the way the camera moves\nin relation to the player";
OPTION_TOOLTIP_CHAT_LOCKED = "Locks all chat windows so they\ncannot accidentally be altered";
...
OPTION_TOOLTIP_CLICK_TO_MOVE = "Use mouse clicks to move your character\ninstead of the keyboard";
...
OPTION_TOOLTIP_GUILDMEMBER_ALERT = "Show a message when your\nguild members login and logout";
...
OPTION_TOOLTIP_PERIODIC_EFFECTS = "Show damage caused by periodic spells";
OPTION_TOOLTIP_PET_MELEE_DAMAGE = "Show melee damage caused by your pet";
...
OPTION_TOOLTIP_SIMPLE_CHAT = "Sets up a main chat window and a\ncombat log that cannot be reconfigured";
OPTION_TOOLTIP_SOUND_VOLUME = "Adjusts the sound effect volume ";
OPTION_TOOLTIP_STATUS_BAR_TEXT = "Always show health, mana, and XP text";
...
OPTION_TOOLTIP_UBERTOOLTIPS = "Enable detailed tooltips in the lower\nright hand corner of the screen";
...
PHYSICAL_HARASSMENT_DESCRIPTION = "The sole purpose and intent in any action used to continually upset, aggravate, or otherwise annoy another player, may be considered Physical Harassment or \"grief play\".";
PHYSICAL_HARASSMENT_TEXT4 = "Stealing another player's kills";
...
PHYSICAL_HARASSMENT_TEXT2 = "Legally killing another player";
...
RANGED_ATTACK_POWER_TOOLTIP = "Ranged Attack Power";
...
SHOW_PET_MELEE_DAMAGE = "Show pet melee damage";
...
SPIRIT_TOOLTIP = "Increases Health and Mana regeneration. Spirit affects all\ncharacters' Mana and Hit Point regeneration rates in and\nout of combat. Spirit also increases your chance to ‘proc’\nwith weapons. "; -- Tooltip description for "Spirit"
...
STUCK_BUTTON_TEXT = "I'm Stuck";
STUCK_OPTION = "Stuck Option";
STUCK_TEXT = "This option should only be used if your character is physically stuck in the game world.  By selecting this option  your character will be frozen and then sent to its bind point.  Your location will also be submitted for review.";
...
TUTORIAL37 = "One of your items has broken!  You will see a red warning indicator below your minimap.  Until you repair it, you will not be able to use it.";
TUTORIAL36 = "The durability of one of your items is getting low.  You will see a yellow warning indicator below your minimap.  Find a merchant in town to repair it before it breaks!";
...
USE_SOULSTONE = "Use Soulstone"; -- Use your soulstone if you have one
USE_UBERTOOLTIPS = "Use UberTooltips";
USE_UISCALE = "Use UI Scale";
VERBAL_HARASSMENT = "Verbal Harassment";
VERBAL_HARASSMENT_DESCRIPTION = "The verbal abuse from one player to another.  While profanity in and of itself is not considered illegal, verbally assaulting a player can be considered harassment.  ";
VERBAL_HARASSMENT_TEXT1 = "Below are some tips to deal with verbal harassment:";
VERBAL_HARASSMENT_TEXT4 = "Derogatory or hateful comments that are sexual, racist, or religious in nature are always considered harassment";
...
VOICEMACRO_20_Or_0_FEMALE = "Get between me and my food, and you'll loose a hand.";
